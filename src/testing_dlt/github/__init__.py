...
def github_repo_events(
    ...
    def repo_events(
        ...
        for page in helpers.get_rest_pages(
            access_token, repos_path + "?per_page=100"
        ):
            yield page
...
@dlt.source
def github_default_branch_commits(
    owner: str,
    name: str,
    access_token: str = dlt.secrets.value,
    page_size: int = 100,
    ...
    return (
        dlt.resource(
            helpers.get_default_branch_commits(
                owner,
                name,
                access_token,
                page_size,
